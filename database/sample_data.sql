...
-- FIXED: Insert connections with normalized direction (smaller ID first)
...
-- Note: Connections are bidirectional in functionality but stored in one direction only
-- The pathfinding algorithm treats them as bidirectional automatically